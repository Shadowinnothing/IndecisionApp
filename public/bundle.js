...
var IndecisionApp = function (_React$Component) {
  ...
  _createClass(IndecisionApp, [{
    ...
    value: function deleteOptionHandler(option) {
      this.setState(function (prevState) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Action2.default, { pickHandler: this.pickHandler, hasOptions: this.state.options.length > 0 }),
        _react2.default.createElement(_Options2.default, {
          options: this.state.options,
          deleteOptionsHandler: this.deleteOptionsHandler,
          deleteOptionHandler: this.deleteOptionHandler
        }),
        _react2.default.createElement(_AddOption2.default, { addOptionHandler: this.addOptionHandler })
      );
    }
  }]);
...
var AddOption = function (_Component) {
  ...
  _createClass(AddOption, [{
    ...
    value: function handleAddOption(e) {
      ...
      var err = this.props.addOptionHandler(option);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', { autoComplete: 'off', name: 'optionInput', type: 'text' }),
          _react2.default.createElement(
            'button',
            null,
            'Add Option'
...
var _Option = __webpack_require__(22);
